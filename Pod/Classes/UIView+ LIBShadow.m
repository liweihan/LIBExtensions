...
- (void) li_makeInsetShadow
{
    ...
    UIView *shadowView = [self li_makeInsetShadowWithRadiuscreateShadowViewWithRadius:3 Color:color Directions:shadowDirections];
...
- (void) li_makeInsetShadowWithRadius:(float)radius alpha:(float)alpha
{
    ...
    UIView *shadowView = [self li_makeInsetShadowWithRadiuscreateShadowViewWithRadius:radius Color:color Directions:shadowDirections];
    shadowView.tag = kShadowViewTag;
...
{
    UIView *shadowView = [self li_makeInsetShadowWithRadiuscreateShadowViewWithRadius:radius Color:color Directions:directions];
    shadowView.tag = kShadowViewTag;
    
    [self addSubview:shadowView];
}

- (UIView *) li_makeInsetShadowWithRadiuscreateShadowViewWithRadius:(float)radius Color:(UIColor *)color Directions:(NSArray *)directions
{
